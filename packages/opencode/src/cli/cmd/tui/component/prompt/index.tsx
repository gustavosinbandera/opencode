...
export function Prompt(props: PromptProps) {
  ...
  async function submit() {
    ...
    const legacyMcpArgs = (tool: string, objective: string) => {
    ...
    const resolveMcpArgs = (tool: string, objective: string, schema: unknown) => {
      ...
      const idKey = ids.includes("work_item_id")
        ...
        : req[0] ||
          ids[0] ||
          keys.find((key) => required.has(key) && numeric(key)) ||
          keys.find((key) => numeric(key))
